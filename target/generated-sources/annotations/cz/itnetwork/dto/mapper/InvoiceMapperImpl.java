...
public class InvoiceMapperImpl implements InvoiceMapper {
    ...
    @Override
    public void updateEntityFromDto(InvoiceDTO dto, InvoiceEntity entity) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( dto.getBuyer() != null ) {
            ...
            personDTOToPersonEntity1( dto.getBuyer(), entity.getBuyer() );
        }
        else {
        ...
        if ( dto.getSeller() != null ) {
            ...
            personDTOToPersonEntity1( dto.getSeller(), entity.getSeller() );
        }
        else {
